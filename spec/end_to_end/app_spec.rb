...
describe App, type: 'end to end' do
  subject(:load_application) { described_class.new(load_paths:, output: printer, input:) }
  ...
  describe 'searching for users' do
    ...
    context 'when there are no users to be found' do
      let(:input_commands) { %w[1 _id 999 n] }
  ...
  describe 'searching for organizations' do
    ...
    context 'when there are no organizations to be found' do
      let(:input_commands) { %w[2 _id 0 n] }
